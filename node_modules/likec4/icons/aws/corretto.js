...
const a = (o) => /* @__PURE__ */ v("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 80 80", ...o, children: [
  /* @__PURE__ */ h("defs", { children: /* @__PURE__ */ v("linearGradient", { id: "Corretto_svg__a", x1: "0%", x2: "100%", y1: "100%", y2: "0%", children: [
    /* @__PURE__ */ h("stop", { offset: "0%", stopColor: "#2E27AD" }),
    /* @__PURE__ */ h("stop", { offset: "100%", stopColor: "#527FFF" })
  ] }) }),
  /* @__PURE__ */ v("g", { fill: "none", fillRule: "evenodd", children: [
    /* @__PURE__ */ h("path", { fill: "url(#Corretto_svg__a)", d: "M0 0h80v80H0z" }),
    /* @__PURE__ */ h(
      "path",
      {
        fill: "#FFF",
