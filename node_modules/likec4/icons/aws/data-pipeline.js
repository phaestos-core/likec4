...
const l = (e) => /* @__PURE__ */ c("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 80 80", ...e, children: [
  /* @__PURE__ */ h("defs", { children: /* @__PURE__ */ c("linearGradient", { id: "Data-Pipeline_svg__a", x1: "0%", x2: "100%", y1: "100%", y2: "0%", children: [
    /* @__PURE__ */ h("stop", { offset: "0%", stopColor: "#4D27A8" }),
    /* @__PURE__ */ h("stop", { offset: "100%", stopColor: "#A166FF" })
  ] }) }),
  /* @__PURE__ */ c("g", { fill: "none", fillRule: "evenodd", children: [
    /* @__PURE__ */ h("path", { fill: "url(#Data-Pipeline_svg__a)", d: "M0 0h80v80H0z" }),
    /* @__PURE__ */ h(
      "path",
      {
        fill: "#FFF",
