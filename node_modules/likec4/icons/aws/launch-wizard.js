...
const l = (a) => /* @__PURE__ */ v("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 80 80", ...a, children: [
  /* @__PURE__ */ h("defs", { children: /* @__PURE__ */ v("linearGradient", { id: "Launch-Wizard_svg__a", x1: "0%", x2: "100%", y1: "100%", y2: "0%", children: [
    /* @__PURE__ */ h("stop", { offset: "0%", stopColor: "#B0084D" }),
    /* @__PURE__ */ h("stop", { offset: "100%", stopColor: "#FF4F8B" })
  ] }) }),
  /* @__PURE__ */ v("g", { fill: "none", fillRule: "evenodd", children: [
    /* @__PURE__ */ h("path", { fill: "url(#Launch-Wizard_svg__a)", d: "M0 0h80v80H0z" }),
    /* @__PURE__ */ h(
      "path",
      {
        fill: "#FFF",
