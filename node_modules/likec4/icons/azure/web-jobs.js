...
const t = (l) => /* @__PURE__ */ o("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 18 18", ...l, children: [
  /* @__PURE__ */ o("defs", { children: [
    /* @__PURE__ */ o("linearGradient", { id: "Web-Jobs_svg__b", x1: 3.844, x2: 3.817, y1: 9.561, y2: 6.165, gradientUnits: "userSpaceOnUse", children: [
      /* @__PURE__ */ f("stop", { offset: 0, stopColor: "#ccc" }),
      /* @__PURE__ */ f("stop", { offset: 0.123, stopColor: "#d7d7d7" }),
      /* @__PURE__ */ f("stop", { offset: 1, stopColor: "#fcfcfc" })
    ] }),
    /* @__PURE__ */ o("linearGradient", { id: "Web-Jobs_svg__c", x1: 8.763, x2: 8.763, y1: 12.958, y2: 9.913, gradientUnits: "userSpaceOnUse", children: [
      /* @__PURE__ */ f("stop", { offset: 0, stopColor: "#ccc" }),
      /* @__PURE__ */ f("stop", { offset: 0.123, stopColor: "#d7d7d7" }),
      /* @__PURE__ */ f("stop", { offset: 1, stopColor: "#fcfcfc" })
    ] }),
    /* @__PURE__ */ o(
      "linearGradient",
      {
        ...
        children: [
          /* @__PURE__ */ f("stop", { offset: 0, stopColor: "#32bedd" }),
          /* @__PURE__ */ f("stop", { offset: 0.576, stopColor: "#32ceef" }),
          /* @__PURE__ */ f("stop", { offset: 1, stopColor: "#32d4f5" })
        ]
      }
    ),
    /* @__PURE__ */ o(
      "radialGradient",
      {
        ...
        gradientUnits: "userSpaceOnUse",
        children: [
          /* @__PURE__ */ f("stop", { offset: 0.183, stopColor: "#5ea0ef" }),
          /* @__PURE__ */ f("stop", { offset: 1, stopColor: "#0078d4" })
        ]
      }
    )
  ] }),
  ...
  /* @__PURE__ */ f("circle", { cx: 3.825, cy: 7.157, r: 2.343, fill: "url(#Web-Jobs_svg__b)" }),
  /* @__PURE__ */ f("g", { fill: "#f2f2f2", children: /* @__PURE__ */ f(
    "path",
    {
  ...
  /* @__PURE__ */ f("circle", { cx: 8.763, cy: 11.435, r: 1.522, fill: "url(#Web-Jobs_svg__c)" }),
  /* @__PURE__ */ f(
    "path",
    {
      fill: "#f2f2f2",
  ...
  /* @__PURE__ */ f("circle", { cx: 12.232, cy: 7.66, r: 1.617, fill: "#f2f2f2" }),
  /* @__PURE__ */ f(
    "path",
    {
      fill: "#f2f2f2",
  ...
  /* @__PURE__ */ f("circle", { cx: 3.825, cy: 7.157, r: 2.343, fill: "url(#Web-Jobs_svg__b)" }),
  /* @__PURE__ */ f("circle", { cx: 8.763, cy: 11.435, r: 1.522, fill: "#f2f2f2" }),
  /* @__PURE__ */ f(
    "path",
    {
  ...
  /* @__PURE__ */ f("circle", { cx: 13.151, cy: 11.507, r: 1.941, fill: "#fff" }),
  /* @__PURE__ */ f("circle", { cx: 4.131, cy: 14.377, r: 1.528, fill: "#fff" })
] });
var e = t;
export {
  e as default
