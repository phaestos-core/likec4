...
const m = (z) => /* @__PURE__ */ v("svg", { xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 18 18", ...z, children: [
  /* @__PURE__ */ h("rect", { width: 4.286, height: 18, fill: "url(#Defender-Slot_svg__a)", rx: 1 }),
  /* @__PURE__ */ h(
    "path",
    {
      fill: "#fff",
  ...
  /* @__PURE__ */ h("defs", { children: /* @__PURE__ */ v("linearGradient", { id: "Defender-Slot_svg__a", x1: 2.143, x2: 2.143, y1: 18, y2: 0, gradientUnits: "userSpaceOnUse", children: [
    /* @__PURE__ */ h("stop", { stopColor: "#0078D4" }),
    /* @__PURE__ */ h("stop", { offset: 0.156, stopColor: "#1380DA" }),
    /* @__PURE__ */ h("stop", { offset: 0.528, stopColor: "#3C91E5" }),
    /* @__PURE__ */ h("stop", { offset: 0.822, stopColor: "#559CEC" }),
    /* @__PURE__ */ h("stop", { offset: 1, stopColor: "#5EA0EF" })
  ] }) })
] });
var H = m;
export {
