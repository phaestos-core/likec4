...
const a = (r) => /* @__PURE__ */ t("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 18 18", ...r, children: [
  /* @__PURE__ */ t("defs", { children: [
    ...
    /* @__PURE__ */ t(
      "radialGradient",
      {
        ...
        gradientUnits: "userSpaceOnUse",
        children: [
          /* @__PURE__ */ s("stop", { offset: 0.27, stopColor: "#ffd70f" }),
          /* @__PURE__ */ s("stop", { offset: 1, stopColor: "#fea11b" })
        ]
      }
    )
  ] }),
  ...
  /* @__PURE__ */ s("path", { fill: "#fff", d: "M7.9 9a4.1 4.1 0 0 1-2.27-.67l2.25 5.89 2.24-5.85A4.17 4.17 0 0 1 7.9 9", opacity: 0.8 }),
  /* @__PURE__ */ s("circle", { cx: 7.9, cy: 4.8, r: 4.21, fill: "url(#User-Subscriptions_svg__b)" }),
  /* @__PURE__ */ s(
    "path",
    {
