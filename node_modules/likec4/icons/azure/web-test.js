...
const e = (f) => /* @__PURE__ */ a("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 18 18", ...f, children: [
  /* @__PURE__ */ a("defs", { children: [
    /* @__PURE__ */ a("linearGradient", { id: "Web-Test_svg__b", x1: 3.459, x2: 3.431, y1: 9.738, y2: 6.226, gradientUnits: "userSpaceOnUse", children: [
      /* @__PURE__ */ t("stop", { offset: 0, stopColor: "#ccc" }),
      /* @__PURE__ */ t("stop", { offset: 0.123, stopColor: "#d7d7d7" }),
      /* @__PURE__ */ t("stop", { offset: 1, stopColor: "#fcfcfc" })
    ] }),
    /* @__PURE__ */ a("linearGradient", { id: "Web-Test_svg__c", x1: 8.547, x2: 8.547, y1: 13.251, y2: 10.102, gradientUnits: "userSpaceOnUse", children: [
      /* @__PURE__ */ t("stop", { offset: 0, stopColor: "#ccc" }),
      /* @__PURE__ */ t("stop", { offset: 0.123, stopColor: "#d7d7d7" }),
      /* @__PURE__ */ t("stop", { offset: 1, stopColor: "#fcfcfc" })
    ] }),
    /* @__PURE__ */ a(
      "linearGradient",
      {
        ...
        children: [
          /* @__PURE__ */ t("stop", { offset: 0, stopColor: "#32d4f5" }),
          /* @__PURE__ */ t("stop", { offset: 0.321, stopColor: "#31d1f3" }),
          /* @__PURE__ */ t("stop", { offset: 1, stopColor: "#198ab3" })
        ]
      }
    ),
    /* @__PURE__ */ a(
      "radialGradient",
      {
        ...
        gradientUnits: "userSpaceOnUse",
        children: [
          /* @__PURE__ */ t("stop", { offset: 0.183, stopColor: "#5ea0ef" }),
  ...
  /* @__PURE__ */ t("circle", { cx: 3.439, cy: 7.251, r: 2.424, fill: "url(#Web-Test_svg__b)" }),
  /* @__PURE__ */ t("g", { fill: "#f2f2f2", children: /* @__PURE__ */ t(
    "path",
    {
  ...
  /* @__PURE__ */ t("circle", { cx: 8.547, cy: 11.677, r: 1.575, fill: "url(#Web-Test_svg__c)" }),
  /* @__PURE__ */ t(
    "path",
    {
      fill: "#f2f2f2",
  ...
  /* @__PURE__ */ t("circle", { cx: 12.136, cy: 7.772, r: 1.672, fill: "#fff" }),
  /* @__PURE__ */ t(
    "path",
    {
      fill: "#f2f2f2",
  ...
  /* @__PURE__ */ t("circle", { cx: 3.439, cy: 7.251, r: 2.424, fill: "#fff" }),
  /* @__PURE__ */ t("circle", { cx: 8.547, cy: 11.677, r: 1.575, fill: "#fff" }),
  /* @__PURE__ */ t(
    "path",
    {
