...
const c = (f) => /* @__PURE__ */ p("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 128 128", ...f, children: [
  ...
  /* @__PURE__ */ l(
    ...
    {
      fill: "#fe405f",
      d: "M48.023 80.945C39.75 70.902 32 60.758 30.797 58.395l-2.192-4.29 8.875-8.917 8.872-8.922h34.23l8.93 8.98 8.933 8.98-2.406 4.087c-2.902 4.925-31.195 40.757-32.242 40.835-.406.028-7.504-8.164-15.774-18.203m0 0"
    }
  ),
  /* @__PURE__ */ l(
    "path",
