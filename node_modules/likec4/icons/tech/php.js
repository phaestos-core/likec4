...
const t = (h) => /* @__PURE__ */ l("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 128 128", ...h, children: [
  /* @__PURE__ */ a(
    "path",
    {
      fill: "url(#PHP_svg__a)",
  ...
  /* @__PURE__ */ a("path", { d: "M34.772 67.864c2.793 0 4.877-.515 6.196-1.53 1.306-1.006 2.207-2.747 2.68-5.175.44-2.27.272-3.854-.5-4.71-.788-.874-2.493-1.317-5.067-1.317h-4.464l-2.473 12.732zM20.173 83.547a.694.694 0 0 1-.68-.828l6.557-33.738a.695.695 0 0 1 .68-.561h14.134c4.442 0 7.748 1.206 9.827 3.585 2.088 2.39 2.734 5.734 1.917 9.935-.333 1.711-.905 3.3-1.7 4.724a15.8 15.8 0 0 1-3.128 3.92c-1.531 1.432-3.264 2.472-5.147 3.083-1.852.604-4.232.91-7.07.91h-5.724l-1.634 8.408a.695.695 0 0 1-.682.562z" }),
  /* @__PURE__ */ a(
    "path",
    {
      fill: "#fff",
  ...
  /* @__PURE__ */ a("path", { d: "M69.459 74.577a.694.694 0 0 1-.682-.827l2.9-14.928c.277-1.42.209-2.438-.19-2.87-.245-.263-.979-.704-3.15-.704h-5.256l-3.646 18.768a.695.695 0 0 1-.683.56h-7.29a.695.695 0 0 1-.683-.826l6.558-33.739a.695.695 0 0 1 .682-.561h7.29a.695.695 0 0 1 .683.826L64.41 48.42h5.653c4.307 0 7.227.758 8.928 2.321 1.733 1.593 2.275 4.14 1.608 7.573l-3.051 15.702a.695.695 0 0 1-.682.56z" }),
  /* @__PURE__ */ a(
    "path",
    {
      fill: "#fff",
  ...
  /* @__PURE__ */ a("path", { d: "M92.136 67.864c2.793 0 4.878-.515 6.198-1.53 1.304-1.006 2.206-2.747 2.679-5.175.44-2.27.273-3.854-.5-4.71-.788-.874-2.493-1.317-5.067-1.317h-4.463l-2.475 12.732zM77.54 83.547a.694.694 0 0 1-.682-.828l6.557-33.738a.695.695 0 0 1 .682-.561H98.23c4.442 0 7.748 1.206 9.826 3.585 2.089 2.39 2.734 5.734 1.917 9.935a15.9 15.9 0 0 1-1.699 4.724 15.8 15.8 0 0 1-3.128 3.92c-1.53 1.432-3.265 2.472-5.147 3.083-1.852.604-4.232.91-7.071.91h-5.723l-1.633 8.408a.695.695 0 0 1-.683.562z" }),
  /* @__PURE__ */ a(
    "path",
    {
      fill: "#fff",
  ...
  /* @__PURE__ */ a("defs", { children: /* @__PURE__ */ l(
    "radialGradient",
    {
      ...
      children: [
        /* @__PURE__ */ a("stop", { stopColor: "#AEB2D5" }),
        /* @__PURE__ */ a("stop", { offset: 0.3, stopColor: "#AEB2D5" }),
        /* @__PURE__ */ a("stop", { offset: 0.75, stopColor: "#484C89" }),
        /* @__PURE__ */ a("stop", { offset: 1, stopColor: "#484C89" })
      ]
    }
  ) })
] });
