...
const p = (l) => /* @__PURE__ */ t("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 128 128", ...l, children: [
  /* @__PURE__ */ c(
    "path",
    {
      fill: "#128dff",
  ...
  /* @__PURE__ */ c(
    ...
    {
      fill: "#8bda67",
      d: "M45.477 66.422a30.5 30.5 0 0 0-14.907-3.867C13.703 62.555.035 76.18.035 92.985c0 16.804 13.668 30.43 30.535 30.43 16.946 0 30.95-14.337 30.524-31.212H43.906c-.453 0-.808.383-.812.832-.043 6.723-5.672 12.434-12.524 12.434-6.922 0-12.527-5.59-12.527-12.485S23.648 80.5 30.57 80.5c1.809 0 3.532.383 5.086 1.074.383.168.836.04 1.047-.316zm0 0"
    }
  ),
  /* @__PURE__ */ c(
    "path",
