...
const m = (l) => /* @__PURE__ */ z("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 128 128", ...l, children: [
  /* @__PURE__ */ c(
    "path",
    {
      fill: "#d33833",
      d: "M108.893 61.68c0 25.36-20.099 45.918-44.892 45.918S19.108 87.04 19.108 61.68s20.1-45.92 44.893-45.92 44.892 20.56 44.892 45.92"
    }
  ),
  /* @__PURE__ */ c(
    "path",
  ...
  /* @__PURE__ */ c(
    ...
    {
      fill: "#231f20",
      d: "M33.253 30.355c-7.876 8.06-12.75 19.186-12.75 31.496 0 12.307 4.874 23.436 12.75 31.494 7.88 8.057 18.74 13.03 30.747 13.03s22.867-4.973 30.747-13.03c7.876-8.058 12.751-19.187 12.751-31.494 0-12.31-4.875-23.437-12.751-31.496C86.867 22.3 76.007 17.327 64 17.326c-12.006.001-22.867 4.973-30.747 13.03zM31.26 95.294c-8.37-8.561-13.546-20.392-13.546-33.443 0-13.053 5.176-24.883 13.546-33.444 8.37-8.563 19.954-13.87 32.74-13.869 12.788-.002 24.374 5.306 32.741 13.869 8.372 8.561 13.548 20.392 13.547 33.444 0 13.05-5.175 24.882-13.547 33.443-8.367 8.562-19.953 13.87-32.74 13.87s-24.372-5.308-32.74-13.87"
    }
  ),
  /* @__PURE__ */ c(
    "path",
  ...
  /* @__PURE__ */ c(
    ...
    {
      fill: "#335061",
      d: "m88.027 56.975-4.103 4.105v15.904l-3.58 14.66-1.721.047 1.367 16.418 6.498-.855L84.95 91.52l-2.902.079 7.863-.422s3.932-9.919 3.932-10.432 3.422-14.365 3.422-14.365l-7.698-8.037-1.539-1.37zm-41.215 2.564-4.275 1.711-13.682 9.406.856 2.737 3.934 11.628 1.709 19.327 1.197 2.05 17.101 5.817 1.028-1.2-2.053-14.365v-4.103l24.455-1.027 1.88-1.026-14.876-7.012 2.736-5.3-3.933 1.367-1.54-1.881-2.052-8.893-1.711-.513-3.762-1.198-3.25-2.906z"
    }
  ),
  /* @__PURE__ */ c(
    "path",
    {
      fill: "#6d6b6d",
      d: "m36.551 31.835 4.446-1.54 3.592 1.711 1.71 3.762 2.053-.342.513-2.052-1.026-3.933 1.026-9.407-.856-5.13 3.079-3.592 6.67-5.301-1.882-2.565-9.406 4.617-3.933 3.079-2.224 4.788-3.42 4.617-1.026 5.473z"
    }
  ),
  /* @__PURE__ */ c(
    "path",
    {
      fill: "#dcd9d8",
      d: "M59.445 4.021c-1.172-.012-2.543.108-2.543.108L45.787 8.406l-4.277 4.276-1.881 3.42 3.934-.342s2.565-6.328 12.826-9.406c6.413-1.924 5.01-2.312 3.056-2.333M48.01 14.904l-9.406 2.223-2.737 8.893.684 5.814 1.88-1.195s-3.591-11.974 10.09-13.684z"
    }
  ),
  /* @__PURE__ */ c(
    "path",
  ...
  /* @__PURE__ */ c(
    ...
    {
      fill: "#81b0c4",
      d: "M84.48 74.486a4.2 4.2 0 0 0-1.767.42c-.178 4.412-.68 10.199-1.856 13.656 2.805-3.571 5.066-7.73 7.43-11.779-.756-1.213-2.129-2.31-3.807-2.297M71.71 76.03c-2.714 1.82-5.7 3.532-6.463 6.836 3.884 2.198 8.412 4.365 12.844 5.701-1.876-4.41-3.58-8.982-6.381-12.537"
    }
  ),
  /* @__PURE__ */ c(
    "path",
